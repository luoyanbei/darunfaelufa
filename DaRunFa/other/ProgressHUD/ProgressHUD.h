...
#define HUD_IMAGE_SUCCESS		[UIImage imageWithContentsOfFile:@""]//[UIImage imageNamed:@"ProgressHUD.bundle/progresshud-success.png"]
#define HUD_IMAGE_ERROR			[UIImage imageWithContentsOfFile:@""]//[UIImage imageNamed:@"ProgressHUD.bundle/progresshud-error.png"]
